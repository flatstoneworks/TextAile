...
from .routers import chat_router, conversations_router, models_router
from .services import LLMInferenceService, ConversationStore
...
async def lifespan(app: FastAPI):
    ...
    global inference_service, conversation_store
